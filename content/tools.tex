...
Das Open-Source Projekt \emph{XPlanner} hat es sich zur Aufgabe gemacht, die Verwaltung von XP (Extreme Programming) Projekten zu unterstützen. \emph{XPlanner} ist ebenfalls ein web-basiertes Werkzeug, dass über einen Webbrowser bedient werden kann. Dabei werden die Methoden des XP durch folgende Features unterstützt:
\begin{itemize}
...
Die Aufwandserfassung ermöglicht \dots
